...
pass_args_repo = {
    ...
    "activation_statistics": {
        "range_quantile": {"device": "cpu", "dims": "all", "quantile": 0.1} # collect 97% quantile of the activation range
    },
...
## Compare weights from MG and ORI_MG

#Question: why change the presition format did not change the output?
...
#             result_integer_number = layer.weight.data.dtype
#             print('the results torch type', result_integer_number)
#             args_weights_precision = layer.weight.data.dtype
