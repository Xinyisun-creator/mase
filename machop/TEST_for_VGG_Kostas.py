...
from chop.passes.graph.transforms.quantize.quantize_tensorRT_Kostas import tensorRT_quantize_pass,calibration_pass,export_onnx_to_tensorRT_engine_pass,test_quantize_tensorrt_transform_pass,DEMO_combine_ONNX_and_Engine
...
batch_size = 16 ### dont be 64 plz (maybe max is 32, nobody knows)
model_name = "vgg7"
...
# mg, _, ONNX_engine= export_onnx_to_tensorRT_engine_pass(mg,dummy_in,input_generator,onnx_model_path = './testdemo.onnx',TR_output_path=engine_str_path_ori)
# test_quantize_tensorrt_transform_pass(data_module.train_dataloader(), engine_str_path_ori,model_name,ONNX_engine)
datamodule_test = data_module.train_dataloader()
DEMO_combine_ONNX_and_Engine(mg,dummy_in,datamodule_test,input_generator,onnx_model_path = './testdemo.onnx',TR_output_path=engine_str_path_ori)
print(model_info)
